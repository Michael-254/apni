                ...
                <ul class="navbar-nav mr-auto d-flex align-items-center">
                    ...
                    <?php if(!empty($navbarPages) and count($navbarPages)): ?>
                        <?php $__currentLoopData = $navbarPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navbarPage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if($navbarPage['title'] == 'Home'): ?> <?php echo classActiveOnlyPath('/'); ?> <?php endif; ?>" href="<?php echo e($navbarPage['link']); ?>"><?php echo e($navbarPage['title']); ?></a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </ul>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laravel projects\LMS\resources\views/web/default/includes/navbar.blade.php ENDPATH**/ ?>