                        ...
                        <div class="">
                            ...
                            <div class="mt-35 d-flex align-items-center">
                                <?php if(!empty($becomeInstructorSection['button1'])): ?>
                                    <a href="<?php echo e(empty($authUser) ? '/login' : (($authUser->isUser()) ? $becomeInstructorSection['button1']['link'] : '/panel/setting')); ?>" class="btn btn-primary"><?php echo e($becomeInstructorSection['button1']['title']); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel projects\LMS\resources\views/web/default/pages/home.blade.php ENDPATH**/ ?>