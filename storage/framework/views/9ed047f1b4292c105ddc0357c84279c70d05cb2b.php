                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                    ...
                                    <?php if($webinar->isOwner($authUser->id) or $webinar->isPartnerTeacher($authUser->id)): ?>
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu ">
                                                ...
                                                <a href="/panel/webinars/<?php echo e($webinar->id); ?>/step/3" class="webinar-actions d-block mt-10"><?php echo e(trans('public.files')); ?></a>
                                ...
                                <div class="webinar-price-box mt-15">
                                    <?php if($webinar->price > 0): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <span class="real">Accessible</span>
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel projects\LMS\resources\views/web/default/panel/webinar/index.blade.php ENDPATH**/ ?>