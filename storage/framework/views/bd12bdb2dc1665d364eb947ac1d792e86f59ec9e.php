                ...
                <ul class="sidenav-item-collapse">
                    ...
                    <?php if(!empty($authUser->organ_id)): ?>
                        <li class="mt-5 <?php echo e((request()->is('panel/webinars/organization_classes')) ? 'active' : ''); ?>">
                            <a href="/panel/webinars/purchases">Enrolled Courses</a>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH D:\laravel projects\LMS\resources\views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>