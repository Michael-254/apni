                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($discounts as $discount)
                                        <tr>
                                            ...
                                            <td>{{  $discount->max_amount ?  addCurrencyToPrice($discount->max_amount) : '-' }}</td>
                                            <td>{{  $discount->amount ?  addCurrencyToPrice($discount->amount) : '-' }}</td>
                                            <td>{{  $discount->minimum_order ?  addCurrencyToPrice($discount->minimum_order) : '-' }}</td>
