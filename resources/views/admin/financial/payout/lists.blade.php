                    ...
                    <div class="card">
                        <div class="card-header">
                            @can('admin_payouts_export_excel')
                                <a href="/admin/financial/payouts/excel?{{ http_build_query(request()->all()) }}" class="btn btn-primary">{{ trans('admin/main.export_xls') }}</a>
                            @endcan
                        </div>
                        ...
                        <div class="card-footer text-center">
                            {{ $payouts->appends(request()->input())->links('vendor.pagination.bootstrap-4') }}
                        </div>
