                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @can('admin_become_instructors_reject')
                                                    @if($become->status != 'accept')
                                                        @include('admin.includes.delete_button',['url' => '/admin/users/become-instructors/'. $become->id .'/reject' , 'btnClass' => 'mr-1', 'btnIcon' => 'fa-check','tooltip' => trans('admin/main.reject_request')])
                                                    @endif
                                                @endcan

                                                @can('admin_become_instructors_delete')
                                                    @include('admin.includes.delete_button',['url' => '/admin/users/become-instructors/'. $become->id .'/delete' , 'btnClass' => '','tooltip' => trans('admin/main.delete')])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <div class="card-footer text-center">
                            {{ $becomeInstructors->appends(request()->input())->links('vendor.pagination.bootstrap-4') }}
                        </div>
