                    ...
                    <div class="card">
                        <div class="card-header">
                            @can('admin_store_filters_create')
                                <a href="/admin/store/filters/create" class="btn btn-primary">{{ trans('admin/main.add_new') }}</a>
                            @endcan
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_store_filters_edit')
                                                    <a href="/admin/store/filters/{{ $filter->id }}/edit"
                                                       class="btn-transparent btn-sm text-primary">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endcan
                                                @can('admin_store_filters_delete')
                                                    @include('admin.includes.delete_button',['url' => '/admin/store/filters/'.$filter->id.'/delete'])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
