...
<section class="dashboard">
    <div class="row">
        ...
        <div class="col-12 col-lg-6 mt-35">
            <a href="@if($authUser->isUser()) /panel/webinars/my-comments @else /panel/webinars/comments @endif" class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 d-flex align-items-center">
